...
print(f"Graphe H3 : {global_graph}")
print('-----')

print(f"Sommets de H3 : {set_of_vertices(global_graph)}")
print('-----')

print(f"Voisins de '111' dans H3 : {set_of_neighbors(global_graph, '111')}")
print('-----')

print(f"Degré de '111' dans H3 : {degree_of(global_graph, '111')}")
print('-----')

print(f"Nombre d'arêtes dans H3 : {number_of_edges(global_graph)}")
print('-----')

print(f"H3 symétrique : {is_symmetric(global_graph)}")
print('-----')

print("------ BFS from 000:", bfs(global_graph, "000"))
print('-----')

list_of_vertices = list(set_of_vertices(global_graph))
print(f"------ Color H3 with list {list_of_vertices} : ", color_graph_by_list(global_graph, list_of_vertices))
print('-----')
